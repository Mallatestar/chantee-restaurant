    ...
    <div class="container dark-grey-text mt-5">
        <div class="row wow fadeIn">
            <div class="col-md-6 md-4">
                <img src="https://t8x8a5p2.stackpathcdn.com/wp-content/uploads/2018/05/Strawberry-Cheesecake-Recipe-Image-720x720.jpg" alt="cake1" class="img-fluid" style="height: 300px;">
            </div>
            <div class="col-md-6 md-4">
              <div class="p-4">
                <div class="mb-3">
                ...
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Iure omnis, natus quia quod temporibus sapiente error facilis aut voluptas. Optio architecto magni esse corrupti dolore sed non! Nulla, nam vero!</p>
                <form action="" class="d-flex justify-content-left">
                  ...
                  <button tyype="submit" class="btn btn-primary btn-md my-0 p">
